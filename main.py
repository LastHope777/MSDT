...
arr = [-4633, -1619, -3274, -1029, -1147, 775, -171, -1990, -2795, 25991, -2220, -921, -1862, -600, -1785, -2158, -1422,
       13873, 1068, -3387, -454, 97, -551, -2019, 2267, 19643, -3096, -152, -1697, 1700]
# Мода 🍒
moda = mode(arr)
print("Мода: ", moda)
...
# Третий номер 🌈
print("\n====================Третий номер====================\n")
third_arr = [1.6, 1.9, 2.0, 2.1, 2.2, 2.4, 2.5, 2.6, 2.7, 2.8, 2.8, 2.9, 2.9, 3.0, 3.1, 3.2, 3.2, 3.3, 3.4, 3.4, 3.4,
             3.5, 3.5, 3.5, 3.5, 3.6, 3.7, 3.9]
sr = 0
...
probability = (top_border - average_procent) / standart_otklonenie - \
              (down_border - average_procent) / standart_otklonenie
...
# Проверка статистической значимости
if p_value < alpha:
    print("Отвергаем нулевую гипотезу. Существует существенное различие"
          " средней себестоимости единицы продукции на предприятиях.")
else:
...
# Проверка статистической значимости
if p_value < alpha:
    print("Отвергаем нулевую гипотезу. Существует существенное различие средних"
          " значений дебиторской задолженности в группах.")
else:
